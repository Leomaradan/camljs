...
test("ToStringTwice", () => {
  const builder = new CamlBuilder()
    .View()
    .Query()
    .Where()
    .DateTimeField("Modified")
    .GreaterThanOrEqualTo("2021-01-31T22:00:00.000Z");
...
test("ToStringTwiceUTC", () => {
  const builder = new CamlBuilder()
    .View()
    .Query()
    .Where()
    .DateTimeUTCField("Modified")
    .GreaterThanOrEqualTo("2021-01-31T22:00:00.000Z");
  const query1 = builder.ToString();
  const query2 = builder.ToString();
      ...
      `<View>
            <Query>
                <Where>
                    <Geq>
                        <FieldRef Name="Modified" />
                        <Value IncludeTimeValue="TRUE" StorageTZ="TRUE" Type="DateTime">2021-01-31T22:00:00.000Z</Value>
                    </Geq>
                </Where>
            </Query>
        </View>`
